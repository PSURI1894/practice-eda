...
| [`beijing-air-quality/`](beijing-air-quality/) | UCI Beijing PM2.5 hourly (2010–14) | **Extensive** air-quality EDA (quality, distributions, missingness, temporal/meteorology/extremes/PCA) + **evaluated imputation** + pollution forecasting with extreme/probabilistic warnings (Parts 0–5; more in progress) |
