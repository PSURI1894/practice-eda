...
| [`bike-sharing/`](bike-sharing/) | UCI Bike-Sharing hourly demand (2011–12) | Advanced EDA → multi-seasonal TS → covariate forecasting → walk-forward backtesting & probabilistic intervals → SHAP interpretability (Parts 0–5; more in progress) |
